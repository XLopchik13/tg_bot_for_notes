...
async def start_views_notes(message: Message, state: FSMContext):
    await state.clear()
...
async def all_views_notes(message: Message, state: FSMContext):
    await state.clear()
...
async def date_views_notes(message: Message, state: FSMContext):
    await state.clear()
    all_notes = await get_notes_by_user(user_id=message.from_user.id)
    if all_notes:
...
async def content_type_views_notes(message: Message, state: FSMContext):
    await state.clear()
    all_notes = await get_notes_by_user(user_id=message.from_user.id)
    if all_notes:
...
async def text_views_notes(message: Message, state: FSMContext):
    await state.clear()
    all_notes = await get_notes_by_user(user_id=message.from_user.id)
    if all_notes:
...
async def text_notes_process(message: Message, state: FSMContext):
